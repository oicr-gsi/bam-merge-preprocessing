...
do_sam_filter	| true  | flag for enabling/disabling samtools filtering (quality and other thing defined by samtools_flags	N	true
...
sam-filter-flag	| | bit flag to use for filtering with samtools	N	260 (unmapped reads; not primary alignment)
